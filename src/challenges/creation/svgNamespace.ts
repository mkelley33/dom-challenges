  ...
  solutions: [
    {
      ...
      explanation: [
        ...
        'is not a style choice: on an SVG element `className` is an `SVGAnimatedString`, not a string,',
        'so assigning to it does not set the class. `classList` works on both.',
        '',
