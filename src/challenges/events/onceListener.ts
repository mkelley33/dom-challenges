  ...
  solutions: [
    {
      ...
      explanation: [
        ...
        '',
        'The removal happens **before the callback runs**, which matters more than it sounds: if',
        '`onFirst` throws, or if it dispatches another click at the same button, the registration is',
        'already gone and cannot fire again. A hand-rolled `removeEventListener` at the *end* of the',
        'handler has a window where both are true.',
        '',
