...
import type { PaneEdge } from './PaneResizer';
import { MIN_PANE_PERCENT, PaneResizer, resizePanes } from './PaneResizer';

/** The store's own starting split, so the arithmetic below is the arithmetic a learner meets. */
